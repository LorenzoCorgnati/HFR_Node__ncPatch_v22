    ...
    for nc_idx=1:length(ncFiles)
        try
            ...
            if(contains(ncFiles(nc_idx).folder,'Totals_nc'))
                ...
                ncwriteatt(ncFiles(nc_idx).name,'NSCT','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ...
                ncwriteatt(ncFiles(nc_idx).name,'EWCS','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ...
                ncwriteatt(ncFiles(nc_idx).name,'NSCS','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ...
                if(~contains(siteCODE,'HFR-US','IgnoreCase',true))
                    if(contains(sensorATT,'wera','IgnoreCase',true))
                        ...
                        ncwriteatt(ncFiles(nc_idx).name,'UACC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                        ...
                        ncwriteatt(ncFiles(nc_idx).name,'VACC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                    ...
                    elseif(contains(sensorATT,'codar','IgnoreCase',true))
                        ...
                        ncwriteatt(ncFiles(nc_idx).name,'CCOV','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ...
                ncwriteatt(ncFiles(nc_idx).name,'GDOP','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
            ...
            elseif(contains(ncFiles(nc_idx).folder,'Radials_nc'))
                ...
                if(contains(sensorATT,'codar','IgnoreCase',true))
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'ESPC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'ETMP','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'MINV','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'MAXV','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'ERSC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'ERTC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'XDST','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'YDST','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'SPRC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ...
                elseif(contains(sensorATT,'wera','IgnoreCase',true))
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'HCSS','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                    ...
                    ncwriteatt(ncFiles(nc_idx).name,'EACC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ...
                ncwriteatt(ncFiles(nc_idx).name,'POSITION_QC','long_name',char('Position quality flag'));
                ncwriteatt(ncFiles(nc_idx).name,'POSITION_QC','conventions',char('Copernicus Marine In Situ reference table 2'));
                ncwriteatt(ncFiles(nc_idx).name,'POSITION_QC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ncwriteatt(ncFiles(nc_idx).name,'DEPH_QC','long_name',char('Depth quality flag'));
                ncwriteatt(ncFiles(nc_idx).name,'DEPH_QC','conventions',char('Copernicus Marine In Situ reference table 2'));
                ncwriteatt(ncFiles(nc_idx).name,'QCflag','long_name',char('Overall quality flag'));
                ncwriteatt(ncFiles(nc_idx).name,'QCflag','conventions',char('Copernicus Marine In Situ reference table 2'));
                ncwriteatt(ncFiles(nc_idx).name,'QCflag','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ...
                ncwriteatt(ncFiles(nc_idx).name,'OWTR_QC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ...
                ncwriteatt(ncFiles(nc_idx).name,'MDFL_QC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ncwriteatt(ncFiles(nc_idx).name,'VART_QC','long_name',char('Variance threshold quality flag'));
                ncwriteatt(ncFiles(nc_idx).name,'VART_QC','conventions',char('Copernicus Marine In Situ reference table 2'));
                ncwriteatt(ncFiles(nc_idx).name,'VART_QC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
                ncwriteatt(ncFiles(nc_idx).name,'CSPD_QC','long_name',char('Velocity threshold quality flag'));
                ncwriteatt(ncFiles(nc_idx).name,'CSPD_QC','conventions',char('Copernicus Marine In Situ reference table 2'));
                ncwriteatt(ncFiles(nc_idx).name,'CSPD_QC','coordinates',char('TIME DEPTH LATITUDE LONGITUDE'));
